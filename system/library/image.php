...
class Image {
	...
	public function resizeWithoutWhiteBorders($width = 0, $height = 0, $default = '') {
		if (!$this->width || !$this->height) {
			return;
		}
		...
		// Remove white borders BEGIN
		$cropped = imagecropauto($this->image, IMG_CROP_WHITE);
		if ($cropped !== false) {
			$this->image = $cropped;
		}
		// Remove white borders END
