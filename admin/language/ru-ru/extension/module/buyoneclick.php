<?php
// Heading
$_['heading_name']  	   	= 'Купить в один клик';
...
$_['success_field_tooltip']			= 'Текст по умолчанию: "<h4>Спасибо за Ваш заказ!<br />Мы свяжемся с Вами в ближайшее время.</h4>". Вы можете использовать html-теги.';
