...
class ModelSaleVoucher extends Model {
	...
	public function getVoucherHistories($voucher_id, $start = 0, $limit = 10) {
		...
		$query = $this->db->query("SELECT vh.order_id, CONCAT(o.lastname, ' ', o.firstname, ' ', o.middlename) AS customer, vh.amount, vh.date_added FROM " . DB_PREFIX . "voucher_history vh LEFT JOIN `" . DB_PREFIX . "order` o ON (vh.order_id = o.order_id) WHERE vh.voucher_id = '" . (int)$voucher_id . "' ORDER BY vh.date_added ASC LIMIT " . (int)$start . "," . (int)$limit);
