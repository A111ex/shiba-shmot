...
class ModelTltBlogTltBlog extends Model {
	public function addTltBlog($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "tltblog SET sort_order = '" . (int)$data['sort_order'] . "', image = '" . (isset($data['image']) ? $this->db->escape($data['image']) : '') . "', carousel_images = '" . (isset($data['carousel_images']) ? json_encode($data['carousel_images']) : '') . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', show_title = '" . (isset($data['show_title']) ? (int)$data['show_title'] : 0) . "', status = '" . (int)$data['status'] . "', show_description = '" . (isset($data['show_description']) ? (int)$data['show_description'] : 0) . "'");
	...
	public function editTltBlog($tltblog_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "tltblog SET sort_order = '" . (int)$data['sort_order'] . "', image = '" . (isset($data['image']) ? $this->db->escape($data['image']) : '') . "', carousel_images = '" . (isset($data['carousel_images']) ? json_encode($data['carousel_images']) : '') . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', show_title = '" . (isset($data['show_title']) ? (int)$data['show_title'] : 0) . "', status = '" . (int)$data['status'] . "', show_description = '" . (isset($data['show_description']) ? (int)$data['show_description'] : 0) . "' WHERE tltblog_id = '" . (int)$tltblog_id . "'");
