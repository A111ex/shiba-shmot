      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-telegram" data-toggle="tab"><?php echo $tab_telegram; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_whatsapp" value="<?php echo $config_whatsapp; ?>" placeholder="whatsapp" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-viber">viber</label>
                <div class="col-sm-10">
                  <input type="text" name="config_viber" value="<?php echo $config_viber; ?>" placeholder="viber" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telegram">telegram</label>
                <div class="col-sm-10">
                  <input type="text" name="config_telegram" value="<?php echo $config_telegram; ?>" placeholder="telegram" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-instagram">instagram</label>
                <div class="col-sm-10">
                  <input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" placeholder="instagram" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-vkontakte">vkontakte</label>
                <div class="col-sm-10">
                  <input type="text" name="config_vkontakte" value="<?php echo $config_vkontakte; ?>" placeholder="vkontakte" id="input-fax" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
              <legend>Бегущая строка в шапке сайта</legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-topper_text">Текст в бегущей строке в самом верху страницы</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_topper_text" value="<?php echo $config_topper_text; ?>" placeholder="Текст в бегущей строке в самом верху страницы" id="input-topper_text" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-topper_url">Ссылка в бегущей строке в самом верху страницы</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_topper_url" value="<?php echo $config_topper_url; ?>" placeholder="Ссылка в бегущей строке в самом верху страницы" id="input-topper_url" class="form-control" />
                  </div>
                </div>
              </fieldset>
            </div>
            ...
            <div class="tab-pane" id="tab-ftp">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="password" name="config_ftp_password" value="<?php echo $config_ftp_password; ?>" placeholder="<?php echo $entry_ftp_password; ?>" id="input-ftp-password" class="form-control" />
            ...
            <div class="tab-pane" id="tab-mail">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" name="config_mail_smtp_password" value="<?php echo $config_mail_smtp_password; ?>" placeholder="<?php echo $entry_mail_smtp_password; ?>" id="input-mail-smtp-password" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-alert-email"><?php echo $entry_order_additional_text; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_order_additional_text" rows="5" placeholder="<?php echo $entry_order_additional_text; ?>" id="input-alert-email" class="form-control"><?php echo $config_order_additional_text; ?></textarea>
                  </div>
                </div>
              </fieldset>
            </div>
            ...
            <div class="tab-pane" id="tab-telegram">
              <fieldset>
              <legend>Настройка отправки новинок в telegram</legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Включено</label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_telegram_newsletters) { ?>
                      <input type="radio" name="config_telegram_newsletters" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_telegram_newsletters" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_telegram_newsletters) { ?>
                      <input type="radio" name="config_telegram_newsletters" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_telegram_newsletters" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="config_telegram_token" value="<?php echo $config_telegram_token; ?>" placeholder="Токен бота" class="form-control" />
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 control-label">id чата</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_telegram_chat_id" value="<?php echo $config_telegram_chat_id; ?>" placeholder="id чата" class="form-control" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <textarea name="config_telegram_message" rows="5" placeholder="Текст сообщения" class="form-control"><?php echo $config_telegram_message; ?></textarea>
                  </div>
                </div>
              </fieldset>
            </div>
