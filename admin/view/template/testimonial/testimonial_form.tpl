    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-city"><?php echo 'Город'; ?></label>
            <div class="col-sm-10">
              <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo 'Город'; ?>" id="input-city" class="form-control" />
              <?php if ($error_city) { ?>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-email"><?php echo 'Изображения'; ?></label>
            <div class="photos">
              <?php if ($image1 != '') {
              echo '<img src="' . $image1 . '"/>';
              } ?>
