          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" style="margin-bottom:15px;" name="product_latest_manual" id="product_latest_manual">
                  <option value="0" <?php if (!$product_latest_manual) { echo 'selected';} ?>>По последним артикулам</option>
                  <option value="1" <?php if ($product_latest_manual) { echo 'selected';} ?>>Заданные вручную</option>
              </select>
