                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-middlename<?php echo $address_row; ?>"><?php echo $entry_middlename; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][middlename]" value="<?php echo $address['middlename']; ?>" placeholder="<?php echo $entry_middlename; ?>" id="input-middlename<?php echo $address_row; ?>" class="form-control" />
                          <?php if (isset($error_address[$address_row]['middlename'])) { ?>
                          <div class="text-danger"><?php echo $error_address[$address_row]['middlename']; ?></div>
                          <?php } ?>
                        </div>
                      </div>
                      <div class="form-group">
...
function addAddress() {
	...
	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-middlename' + address_row + '"><?php echo $entry_middlename; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][middlename]" value="" placeholder="<?php echo $entry_middlename; ?>" id="input-middlename' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
