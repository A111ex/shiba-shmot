        ...
        <div class="panel panel-default">
          ...
          <table class="table">
            <tr>
              ...
              <td><?php if ($customer) { ?>
                <a href="<?php echo $customer; ?>" target="_blank"><?php echo $lastname; ?> <?php echo $firstname; ?> <?php echo $middlename; ?></a>
                <?php } else { ?>
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $text_affiliate; ?>
                  <?php if ($affiliate) { ?>
                  (<a href="<?php echo $affiliate; ?>"><?php echo $affiliate_lastname; ?> <?php echo $affiliate_firstname; ?> <?php echo $affiliate_middlename; ?></a>)
                  <?php } ?></td>
