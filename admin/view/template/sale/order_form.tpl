          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-customer">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="middlename" value="<?php echo $middlename; ?>" id="input-middlename" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-payment">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="payment_address" id="input-payment-address" class="form-control">
                    ...
                    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['lastname'] . ' ' . $address['firstname'] . ' ' . $address['middlename'] . ', ' . $address['address_1'] . ', ' . $address['city'] . ', ' . $address['country']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-payment-middlename"><?php echo $entry_middlename; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="middlename" value="<?php echo $payment_middlename; ?>" id="input-payment-middlename" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-shipping">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-middlename"><?php echo $entry_middlename; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="middlename" value="<?php echo $shipping_middlename; ?>" id="input-shipping-middlename" class="form-control" />
                </div>
              </div>
              <div class="form-group">
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#tab-customer input[name=\'middlename\']').val(item['middlename']);
		...
		for (i in  item['address']) {
			html += '<option value="' + item['address'][i]['address_id'] + '">'+item['address'][i]['lastname'] + ' ' + item['address'][i]['firstname'] + ' ' + item['address'][i]['middlename'] + ', ' + item['address'][i]['address_1'] + ', ' + item['address'][i]['city'] + ', ' + item['address'][i]['country'] + '</option>';
		}
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-payment input[name=\'middlename\']').val(json['middlename']);
...
$('select[name=\'shipping_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-shipping input[name=\'middlename\']').val(json['middlename']);
