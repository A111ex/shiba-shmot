...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			$data['affiliate'] = $order_info['affiliate_lastname'] . ' ' . $order_info['affiliate_firstname'] . ' ' . $order_info['affiliate_middlename'];
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['affiliate_middlename'] = $order_info['affiliate_middlename'];
