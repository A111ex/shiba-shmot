...
class ControllerCustomerCustomer extends Controller {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['middlename']) < 1) || (utf8_strlen(trim($this->request->post['middlename'])) > 32)) {
		...
		if (isset($this->request->post['address'])) {
			foreach ($this->request->post['address'] as $key => $value) {
				...
				if ((utf8_strlen($value['middlename']) < 1) || (utf8_strlen($value['middlename']) > 32)) {
					$this->error['address'][$key]['middlename'] = $this->language->get('error_middlename');
				}
