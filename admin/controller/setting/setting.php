...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		$data['entry_order_additional_text'] = $this->language->get('entry_order_additional_text');
		...
		$data['tab_telegram'] = $this->language->get('tab_telegram');
		...
		if (isset($this->request->post['config_topper_text'])) {
			$data['config_topper_text'] = $this->request->post['config_topper_text'];
		} else {
			$data['config_topper_text'] = $this->config->get('config_topper_text');
		}
		
		if (isset($this->request->post['config_topper_url'])) {
			$data['config_topper_url'] = $this->request->post['config_topper_url'];
		} else {
			$data['config_topper_url'] = $this->config->get('config_topper_url');
		}
		...
		if (isset($this->request->post['config_order_additional_text'])) {
			$data['config_order_additional_text'] = $this->request->post['config_order_additional_text'];
		} else {
			$data['config_order_additional_text'] = $this->config->get('config_order_additional_text');
		}
		...
		if (isset($this->request->post['config_telegram_newsletters'])) {
			$data['config_telegram_newsletters'] = $this->request->post['config_telegram_newsletters'];
		} else {
			$data['config_telegram_newsletters'] = $this->config->get('config_telegram_newsletters');
		}

		if (isset($this->request->post['config_telegram_token'])) {
			$data['config_telegram_token'] = $this->request->post['config_telegram_token'];
		} else {
			$data['config_telegram_token'] = $this->config->get('config_telegram_token');
		}
		
		if (isset($this->request->post['config_telegram_chat_id'])) {
			$data['config_telegram_chat_id'] = $this->request->post['config_telegram_chat_id'];
		} else {
			$data['config_telegram_chat_id'] = $this->config->get('config_telegram_chat_id');
		}
		
		if (isset($this->request->post['config_telegram_message'])) {
			$data['config_telegram_message'] = $this->request->post['config_telegram_message'];
		} else {
			$data['config_telegram_message'] = $this->config->get('config_telegram_message');
		}
