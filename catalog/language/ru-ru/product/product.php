...
$_['text_option']                             = 'Доступные размеры: ';
$_['text_minimum']                            = 'Минимальное кол-во для заказа этого товара: %s. ';
$_['text_reviews']                            = '%s отзывов';
$_['text_write']                              = 'Написать отзыв';
$_['text_login']                              = 'Пожалуйста <a class="text-danger" href="%s"> авторизуйтесь</a> или <a class="text-danger" href="%s"> зарегистрируйтесь</a> для просмотра';
