<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-middlename"><?php echo $entry_middlename; ?></label>
        <input type="text" name="middlename" value="<?php echo $middlename; ?>" placeholder="<?php echo $entry_middlename; ?>" id="input-payment-middlename" class="form-control" />
      </div>
      <div class="form-group required">
