              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    <div class="number-spinner">
                      <div class="form-count flexbox">
                        <button class="btn quantity-button btn-minus" data-dir="dwn">-</button>
                        <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="form-control" onkeyup="this.value = this.value.replace (/\D/, ''); calculate(this)"/>
                        <button class="btn quantity-button btn-plus" data-dir="up">+</button>
                      </div>
                    </div>
                    ...
                    <script>
                      function calculate(el) {   
                        ...
                        cart.updateCart($(el).attr('name'),$(el).val().trim());
                      }                        
                    </script> 
