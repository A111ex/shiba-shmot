    ...
    <div id="content" class="account-register <?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group required col-sm-4">
            <label class=" control-label" for="input-middlename"><?php echo $entry_middlename; ?> : </label>
            <div class="">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field col-sm-4" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class=" control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?> : </label><br/>
            <div class="">
        ...
        <fieldset id="address">
          ...
          <div class="form-group required col-sm-6">
            <label class="control-label" for="input-country"><?php echo $entry_country; ?> : </label><br/>
            <div class="">
              <select name="country_id" id="input-country" class="form-control">
                ...
                <?php foreach ($countries as $country) { ?>
                  ...
                  <?php } else if ($country['country_id'] == '176') { ?>
                    <option value="<?php echo $country['country_id']; ?>" selected="selected"><?php echo $country['name']; ?></option>
                  <?php } else { ?>
          ...
          <div class="form-group required col-sm-6">
            <label class="control-label" for="input-zone"><?php echo $entry_zone; ?></label> : <br/>
            <div class="">
          ...
          <div class="form-group required col-sm-6">
            ...
            <div class="">
              <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1_placeholder; ?>" id="input-address-1" class="form-control" />
        ...
        <fieldset id="password">
          ...
          <div class="form-group required col-sm-6">
            <label class="control-label" for="input-confirm"><?php echo $entry_confirm; ?> : </label><br/>
            <div class="">
