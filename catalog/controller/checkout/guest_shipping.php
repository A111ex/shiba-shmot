...
class ControllerCheckoutGuestShipping extends Controller {
	public function index() {
		...
		if (isset($this->session->data['shipping_address']['middlename'])) {
			$data['middlename'] = $this->session->data['shipping_address']['middlename'];
		} else {
			$data['middlename'] = '';
		}
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['shipping_address']['middlename'] = $this->request->post['middlename'];
