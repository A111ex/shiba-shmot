...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (isset($this->session->data['darkMode']) && !empty($this->session->data['darkMode'])) {
			$data['darkMode'] = $this->session->data['darkMode'];
		} else {
			$data['darkMode'] = false;
		}
		...
		if ($this->customer->isLogged()) {
			...
			$data['text_total_wishlist'] = $this->model_account_wishlist->getTotalWishlist();
		} else {
			$data['text_wishlist'] = sprintf($this->language->get('text_wishlist'), (isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : 0));
			$data['text_total_wishlist'] = isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : 0;
		}
		// Compare
	...
	public function darkModeToggler() {
		if (isset($this->request->post['toggleMode'])) {
			$this->session->data['darkMode'] = !$this->session->data['darkMode'];

			$json['darkMode'] = $this->session->data['darkMode'];
