...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$product_total = $this->model_catalog_product->getTotalProducts($filter_data); //disabled for smart_filter by BMV
			//$results = $this->model_catalog_product->getProducts($filter_data); //disabled for smart_filter by BMV
			$results = []; //added for smart_filter by BMV
